class QuestionSetsNewQuestion
  ...
  QUESTION_SETS_NEW_QUESTION_SIZE_SMALL_XPATH = "(.//*[@class='data2Col '])[2]/select/option[2]"
  QUESTION_SETS_NEW_QUESTION_SIZE_RICH_XPATH = "(.//*[@class='data2Col '])[2]/select/option[3]"
  ...
  QUESTION_SETS_NEW_QUESTION_ORDER_INT_XPATH = 3
