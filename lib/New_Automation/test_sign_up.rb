...
class TestSignup < TestBasic
  ...
  def test_invalidEmail
    ...
    assert $wait.until{
      ...
      $browser.find_element(:xpath => SignupModal::ERROR_MESSAGE_XPATH).text == SignupModal::ERROR_TEXT_MESSAGE_XPATH
    }
  end
  ...
  def test_allreadyUsedEmail
    ...
    assert $wait.until{
      $browser.find_element(:xpath => SignupModal::ERROR_MESSAGE_XPATH).displayed?
      $browser.find_element(:xpath => SignupModal::ERROR_MESSAGE_XPATH).text == SignupModal::EXISTING_ACCOUNT_ERROR_TEXT_XPATH
    }
  end
  ...
  def test_invalidPassword
    ...
    assert $wait.until{
      ...
      $browser.find_element(:xpath => SignupModal::ERROR_MESSAGE_PASSWORD_XPATH).text == SignupModal::ERROR_MESSAGE_PASSWORD_TEXT
    }
  end
