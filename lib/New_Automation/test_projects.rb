...
=begin  
  ...
  def test_projectNewJobOrder
    ...
    $browser.find_element(:id, RequisitionsNewAndEdit::REQUISITIONS_NEW_PRIMARY_RECRUITER_TYPE_XPATH).send_keys RequisitionsNewAndEdit::PRIMARY_RECRUITER_TEXT
    $browser.find_element(:id, RequisitionsNewAndEdit::REQUISITIONS_NEW_LOCATION_XPATH).send_keys RequisitionsNewAndEdit::LOCATION_TEXT
    $browser.find_element(:id, RequisitionsNewAndEdit::REQUISITIONS_NEW_DEPARTAMENT_XPATH).send_keys RequisitionsNewAndEdit::DEPARTMENT_TEXT
    $browser.find_element(:id, RequisitionsNewAndEdit::REQUISITIONS_NEW_MIN_SALARY_XPATH).send_keys RequisitionsNewAndEdit::MIN_SALARY_TEXT
    $browser.find_element(:id, RequisitionsNewAndEdit::REQUISITIONS_NEW_MAX_SALARY_XPATH).send_keys RequisitionsNewAndEdit::MAX_SALARY_TEXT
