...
require_relative './pages/short_lists/short_list_review_email_popup.rb'
require_relative './pages/short_lists/short_list_send_email_popup.rb'
require_relative './pages/setup_page.rb'
require_relative './pages/home_page.rb'
require_relative './pages/contacts/contacts_home_page.rb'
require_relative './pages/short_lists/short_list_add_to_popup.rb'
require_relative './pages/short_lists/short_list_creation_page.rb'
require_relative './pages/short_lists/short_list_add_contact_popup.rb'
require_relative './pages/short_lists/short_list_detail_old_ui_page.rb'
