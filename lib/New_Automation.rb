...
#require './New_Automation/tests/candidates_parsing_candidates_file_types'

#require './New_Automation/tests/test_daxtra_parse.rb'

#require './New_Automation/tests/test_eeo_question'
...
#require './New_Automation/tests/test_resume'

#require './New_Automation/tests/test_short_list.rb'
